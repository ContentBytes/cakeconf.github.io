...
export const BioAndAbstract: TopicInfoProps[] = [
  ...
  },
  {
    ...
    bio: (
    <>
      <p>Tech writer who believes docs reveal the ultimate truth about who you are, language is a neurosurgical tool, and writers are the single underutilized resource in IT. Full of hot takes, she spent the last 9 years writing docs, structuring docs, strategizing docs, leading teams who write docs and looking for the best way to do docs in IT, only to discover that it's not about the tooling nor the process, but a secret third thing.</p>
      <Link to="https://www.doc-doctor.org/">doc-doctor.org</Link>
    </>),
    abstract: (
      <>
        <p>Let's talk about how we talk about each other's work.</p>
        <p>In the content world, feedback is currency. In the workplace, it's the force that fuels careers, for better or worse. For content professionals, it's everything.</p>
        <p>In my talk, I'll skip the usual technical review guidelines to explore the subtle ways feedback can shape human brains and reinforce the unspoken workplace dynamics. I'll share my personal feedback manifesto, grounded in neuroscience, psychology, philosophy, and some hard-won experience, to start the conversation about what the 'F' word really means.</p>
        <p>Together, we'll look at how to support clarity without triggering defensiveness, build others up without posturing, and create trust in place of fear.</p>      
      </>),
  ...
  },
  {
    ...
    abstract: (
      <>
      <p>Technical writing teams across industries are quietly revolutionizing how they prepare content for AI integration—but these innovations remain largely undocumented and untested.</p>
      <p>This presentation shares early findings from an ongoing research study investigating documentation strategies that technical writers are developing to optimize content for AI model consumption. Through ethnographic interviews with technical writing professionals across diverse industries, we're creating the first comprehensive catalog of these emerging practices.</p>
      <p>While organizations experiment with everything from structured content formats to prompt-ready documentation, competitive concerns keep effective techniques siloed while less effective approaches proliferate unchecked. This research serves as a neutral academic intermediary to collect and systematically document these strategies.</p>
      <p>Key insights include:</p>
      <ul>
        <li>A taxonomic framework for categorizing AI-preparation techniques based on implementation complexity and intended applications</li>
        <li>Patterns emerging across different industries and organizational contexts</li>
        <li>Early identification of variables that determine strategy effectiveness</li>
        <li>Practical protocols for testing and validating documentation approaches</li>
      </ul>
      <p>What attendees will gain:</p>
      <ul>
        <li>A systematic understanding of current AI-ready documentation practices</li>
        <li>Frameworks for evaluating and selecting appropriate strategies for their contexts</li>
        <li>Insights into how documentation structure influences AI performance</li>
        <li>Actionable approaches for preparing content that works for both human readers and AI systems</li>
      </ul>
      <p>This session bridges the critical gap between rapidly evolving industry practices and academic understanding, offering content strategists proven frameworks rather than experimental guesswork.</p></>),
  ...
  },
  {
    ...
    bio: (
      <>
      <p>Sergio has spent the past 9 years practicing, teaching, and advocating for Content Design. He began as the sole UX Writer at ZnanyLekarz, later leading a team of 10 Content Designers. Along the way, he's also taught at universities and design schools in Barcelona.</p>
      <p>After taking a 6-month sabbatical to prioritize mental health, he's now building the Content Design discipline from the ground up once again, this time at Kave Home, where products aren't just pixels on a screen, but real objects that spark joy. Just like those, numbers can shine, especially when we treat them as words that speak and align: something we'll explore together.</p>
      </>),
  ...
  },
  {
    ...
    bio: (
      <>
      <p>A UX geek, an accessibility advocate, a certified trainer, and UX educator.</p>
      <p>With 5 years of experience as a designer, I've worked across agencies and corporations on projects such as mobile apps, web applications, websites, and enterprise products. I'm also involved in accessibility initiatives and enjoy sharing knowledge about creating more inclusive design solutions.</p>
      </>),
  ...
  },
  {
    ...
    bio: (
      <>
      Dariusz is the co-creator of <Link to="https://techwriter.pl">techwriter.pl</Link> and technical communication postgraduate studies. For twenty years, he has been optimizing content and training in large corporations, startups, and his own companies, with accessibility being his focus for the last five years. He develops accessibility standards within the Standard Accessibility Reporting and W3C organizations. As a hobby, he runs a 3x3 basketball portal with his son.
      </>),
  ...
  },
  {
    ...
    abstract: (
    <>
    <p>What comes to mind when we talk about technical writing genres? In this context, a technical writer usually thinks of various topic types or API reference standards. At least, that was the case for me a few months ago. Then, I became heavily involved in producing release notes.</p>
